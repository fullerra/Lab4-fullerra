...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2012, 4, 10), new DateTime(2012, 4, 11), 10);
            var remainingFlight = new Flight(new DateTime(2012, 4, 12), new DateTime(2012, 4, 13), 10);
